...
--1er test : le client 1 a déjà deux amendes. On essaie de lui attribuer une location.

INSERT INTO Amende values (2,3.2,1,1,TO_DATE('2015/01/16 14:34:11', 'yyyy/mm/dd hh24:mi:ss'));
...
INSERT INTO Amende values (3,3.2,4,3,TO_DATE('2014/12/10 14:34:11', 'yyyy/mm/dd hh24:mi:ss'));
